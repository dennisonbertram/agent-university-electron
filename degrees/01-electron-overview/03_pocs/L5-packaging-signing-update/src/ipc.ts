...
/**
 * The minimal updater-state shape that crosses the IPC boundary in tests.
 * It records the *last* lifecycle event the updater observed plus context.
 * Defined inline here (rather than imported from `./updater`) so the IPC
 * registry can be parsed in unit tests without pulling Electron in.
 */
